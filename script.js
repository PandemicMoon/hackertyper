...
var Typer={
	...
	makeAccess:function(){//create Access Granted popUp      FIXME: popup is on top of the page and doesn't show if the page is scrolled
	...
	makeDenied:function(){//create Access Denied popUp      FIXME: popup is on top of the page and doesn't show if the page is scrolled
		Typer.hidepop(); // hide all popups
	...
	addText:function(key){//Main function to add the code
		if(key.keyCode==18){// key 18 = alt key
			...
			//do nothing
		}else if(key.keyCode==17){ //key 17 = ctrl key
			//do nothing
		}else if(key.keyCode == 91 || key.keyCode == 93 || key.keyCode == 224){ //keys 91, 93, 224 = cmd key
			//do nothing
		}else if(key.keyCode >= 112 && key.keyCode <= 123){ //key 112-123 = F* keys
			//do nothing
